...
let Categoria = (_dec = (0, _typeorm.Entity)('categoria'), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)("uuid"), _dec3 = (0, _typeorm.Column)("varchar"), _dec4 = (0, _typeorm.OneToMany)(type => _Produto.Produto, produto => produto.categoria), _dec5 = (0, _typeorm.OneToOne)(type => _Fornecedor.Fornecedor, fornecedor => fornecedor.categoria), _dec6 = (0, _typeorm.CreateDateColumn)({
  type: "timestamp"
  ...
  constructor() {
    ...
    _initializerDefineProperty(this, "fornecedor", _descriptor4, this);
  ...
  writable: true,
  initializer: null
}), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "fornecedor", [_dec5], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
