...
let Produto = (_dec = (0, _typeorm.Entity)('produto'), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)("uuid"), _dec3 = (0, _typeorm.Column)("varchar"), _dec4 = (0, _typeorm.Column)("integer"), _dec5 = (0, _typeorm.ManyToOne)(type => _Categoria.Categoria, Categoria => Categoria.produtos), _dec6 = (0, _typeorm.ManyToOne)(type => _Fornecedor.Fornecedor, Fornecedor => Fornecedor.produtos), _dec7 = (0, _typeorm.CreateDateColumn)({
  type: "timestamp"
  ...
  constructor() {
    ...
    _initializerDefineProperty(this, "preco", _descriptor3, this);

    _initializerDefineProperty(this, "categoria", _descriptor4, this);

    _initializerDefineProperty(this, "fornecedor", _descriptor5, this);
  ...
  writable: true,
  initializer: null
}), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "preco", [_dec4], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "categoria", [_dec5], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "fornecedor", [_dec6], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
