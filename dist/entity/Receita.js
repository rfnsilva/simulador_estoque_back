...
let Receita = (_dec = (0, _typeorm.Entity)('receita'), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)("uuid"), _dec3 = (0, _typeorm.Column)("integer"), _dec4 = (0, _typeorm.CreateDateColumn)({
  type: "timestamp"
}), _dec5 = (0, _typeorm.CreateDateColumn)({
  type: "timestamp"
}), _dec(_class = (_class2 = (_temp = class Receita {
  constructor() {
