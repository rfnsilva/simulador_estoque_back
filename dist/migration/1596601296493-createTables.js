...
exports.createTables1596601296493 = void 0;

class createTables1596601296493 {
  async up(queryRunner) {
    await queryRunner.query(`CREATE TABLE "receita" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(),
          "valor" integer NOT NULL,
          "createdAt" TIMESTAMP NOT NULL DEFAULT now(),
          "updatedAt" TIMESTAMP NOT NULL DEFAULT now(),
          CONSTRAINT "PK_23451caefbb11b5a2fa29s96828" PRIMARY KEY ("id"))`);
    await queryRunner.query(`CREATE TABLE "contas" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(),
            "valor" integer NOT NULL,
    ...
    await queryRunner.query(`CREATE TABLE "produto" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(),
          ...
          "fornecedorId" uuid,
          CONSTRAINT "REL_0b349f68bca7f05eed39ffb956" UNIQUE ("fornecedorId"),
          "createdAt" TIMESTAMP NOT NULL DEFAULT now(),
          "updatedAt" TIMESTAMP NOT NULL DEFAULT now(),
    ...
    await queryRunner.query(`ALTER TABLE "produto" ADD CONSTRAINT "FK_6252456e912c983cde73d3281db" FOREIGN KEY ("fornecedorId") REFERENCES "fornecedor"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
  }
...
exports.createTables1596601296493 = createTables1596601296493;